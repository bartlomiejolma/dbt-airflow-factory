...
class PowerBIHook(BaseHook):
    ...
    def _get_token(self) -> str:
        ...
        connection_details = pbi_connection.get_extra()
        ...
        data = {
            ...
            'client_id': pbi_connection.client_id,
            'client_secret': pbi_connection.client_secret,
        }
        r = requests.post(self.auth_url, data=data, headers={"Content-Type": "application/x-www-form-urlencoded"})
        r.raise_for_status()
